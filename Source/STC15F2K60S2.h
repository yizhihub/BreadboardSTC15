...
sfr BRT         =   0x9c;   // 独立波特率发生器  // yizhi  这个独立波特率发生器到底能用吗
...
/////the follow is not necessary just for convenient,added form STC15FXXXX.h by yizhi///////
#define ENABLE       1
#define DISABLE      0
#define PolityHigh   1
#define PolityLow    0     // added by yizhi 
//sfr BRT          =  0x9C;
/*   interrupt vector */
