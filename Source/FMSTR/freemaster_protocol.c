...
#if FMSTR_USE_NOEX_CMDS
        /*lint -fallthrough */
        case FMSTR_CMD_READVAR16: // 0xD1U
#endif
...
#if FMSTR_USE_NOEX_CMDS
        /*lint -fallthrough */
        case FMSTR_CMD_READVAR32: // 0xD2U
#endif
...
#if FMSTR_USE_NOEX_CMDS
        /*lint -fallthrough */
        case FMSTR_CMD_SETUPSCOPE: // 0x08U
#endif
            pResponseEnd = FMSTR_SetUpScope(pMessageIO);
            break;  
            
        case FMSTR_CMD_READSCOPE: // 0xc5U
            pResponseEnd = FMSTR_ReadScope(pMessageIO);
            break;
#endif /* FMSTR_USE_SCOPE */
        
#if FMSTR_USE_THROTTLE

        /* 
         * get throttle data 
         */
        case FMSTR_CMD_THROTTLE: // 0x16U
            pResponseEnd = FMSTR_SetThrot(pMessageIO);
            break;  
        
        case FMSTR_CMD_REPORT:   // 0x00U
            pResponseEnd = FMSTR_GetReportData(pMessageIO);
            break;  
            
#endif /* FMSTR_USE_THROTTLE */
...
#if FMSTR_USE_NOEX_CMDS
        /*lint -fallthrough */
        case FMSTR_CMD_WRITEMEMMASK: // 0x03U
#endif
