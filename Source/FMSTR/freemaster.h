...
typedef unsigned char xdata * FMSTR_ADDR;             /* CPU address type, this pointer occupy two bytes, and the datar it points must locate in xdatar space */
...
typedef FMSTR_APPCMD_RESULT (*FMSTR_PAPPCMDFUNC)(FMSTR_APPCMD_CODE fCode, FMSTR_APPCMD_PDATA fPdata, FMSTR_SIZE fSize);
